...
public:
	...
	Component () :
		...
		flags(0),
		awake(true), alive(true), sfont(nullptr), counter(0),
		x(0), y(0), w(0), h(0),
		groupId(0)
	{}
...
public:
	...
	Can be overridden for non-rectangular components (e.g. an indented paragraph of Text)
	*/
	virtual bool contains (int cx, int cy) {
